...
import 'package:capstone_catatan_keuangan/components/input_widget.dart';
import 'package:capstone_catatan_keuangan/components/styles.dart';
import 'package:capstone_catatan_keuangan/components/validators.dart';
...
class _RegisterPageState extends State<RegisterPage> {
  ...
  void register() async {
    ...
    try {
      ...
      await akunCollection.doc(uid).set({
        'uid': uid,
        'nama': nama,
        'email': email,
        'noHP': noHP,
      ...
      Navigator.pushNamedAndRemoveUntil(
          context, '/reports', ModalRoute.withName('/reports'));
    } catch (e) {
